    ...
    <main class="main">
        ...
        <aside class="sidebar">
            <div class="scrollbar-inner">
                ...
                <ul class="navigation">
                    <li class="navigation__active"><a href="index-2.html"><i class="zmdi zmdi-home"></i> Home</a></li>
                    ...
                    <li class="navigation__sub @@variantsactive">
                        ...
                        <ul>
                            ...
                            <li class="@@hiddensidebarboxedactive"><a href="hidden-sidebar-boxed-layout.html">Boxed Layout
                                    with Hidden Sidebar</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="navigation__sub @@componentsactive">
                        ...
                        <ul class="navigation__sub">
                            ...
                            <li class="@@notificationsactive"><a href="notifications-alerts.html">Notifications & Alerts</a>
                            </li>
                        </ul>
                    </li>
